...
const SHARED_RULES = [
  { cat: 'life' as NewsCategory, words: LIFE_WORDS },
  {
    ...
    words: [
      // 治安 / 執法
      '警察', '警方', '犯罪', '刑事', '治安', '公安', '司法', '檢察',
      '起訴', '逮捕', '搜索', '搜索票', '羈押', '假釋', '緩刑', '判決',
      '嫌疑', '涉嫌', '偵查', '被告', '嫌犯', '通緝', '遇害', '受害',
      '違法', '非法', '法院',
      // 刑案類型
      '命案', '凶殺', '殺人', '殺害', '行兇', '持刀', '持槍', '刺殺',
      '槍擊', '槍傷', '槍殺', '開槍', '砍殺',
      '毆打', '鬥毆', '群毆', '暴力', '傷人', '重傷',
      '詐騙', '詐欺', '電話詐騙', '網路詐騙', '詐欺集團', '假冒', '勒索',
      '竊盜', '竊取', '搶奪', '強盜', '搶劫', '入室', '侵入',
      '縱火', '放火', '縱火案', '縱火嫌',
      '綁架', '勒贖', '人質', '挾持', '挾持人質', '人口販賣',
      '毒品', '走私', '藏毒', '販毒', '吸毒', '毒梟',
      '酒駕', '毒駕', '拒檢', '撞人',
      '賄賂', '行賄', '貪污', '收賄',
      // 性別犯罪
      '性侵', '性騷擾', '強制猥褻', '性暴力', '妨害性自主',
      '家暴', '家庭暴力', '兒虐', '兒童虐待', '霸凌',
      // 事故 / 災害
      '意外', '事故', '傷亡', '死亡', '受傷', '罹難', '遇難',
      '車禍', '肇事', '肇逃', '逃逸', '追撞', '翻車', '碰撞', '連環撞',
      '墜落', '墜樓', '跳樓', '墜橋', '墜崖',
      '溺水', '溺斃', '落海', '翻船', '海難', '漁船失聯',
      '火災', '火警', '爆炸', '氣爆', '漏氣', '工安',
      '地震', '颱風', '洪水', '土石流', '坍方', '山崩',
...
const INTL_POLITICS = [
  ...
  // 國際財經市場——避免這類文章混入民生
  '聯準會', '美聯儲', '歐洲央行', 'ECB', '日本央行', '日銀', '英國央行',
  '道瓊', '標普500', '納斯達克', '那斯達克',
  '港股', 'A股', '上證', '深成', '恒生指數',
  'OPEC', 'WTO', 'IMF', '世界銀行', '國際貨幣基金',
  '全球市場', '國際市場', '美元指數',
]
