...
const SHARED_RULES = [
  {
    ...
    words: [
      ...
      '電視劇', '電視節目', '綜藝節目', '電視台', '首映', '票房', '金馬', '金鐘', '金曲', '頒獎',
      'Netflix', '串流', '動漫', '漫畫', '電競', 'Podcast', '時尚', '模特', '造型',
      '新專輯', '巡迴演唱', '粉絲', '發片', '出道', '退圈', '戀愛', '分手', '結婚', '離婚',
      '緋聞', '爭議', '道歉', '退出', '復出', '主持人', '節目主持', '藝能', 'idol',
    ],
  },
  {
    ...
    words: [
      ...
      '新創', 'NVIDIA', '輝達', '晶圓', '封裝', '聯發科', '矽', '量子', '雲端', '數位',
      'ChatGPT', 'OpenAI', '大模型', '機器學習', '深度學習', '算力', '資料中心',
      '手機', '蘋果', 'Apple', 'iPhone', 'Android', '三星', '小米', '華為',
      '資安', '駭客', '資料外洩', '個資', '數位轉型', 'App', '軟體', '硬體',
      '太空', 'SpaceX', '衛星', '自動駕駛', '無人機', '充電樁', '電池', '光電',
      '網路', '寬頻', '光纖', '資訊', '程式', '平台', '演算法', '區塊鏈',
    ],
  },
  {
    ...
    words: [
      ...
      '進口', '經濟', '財政', '上市', '上櫃', '掛牌', '財政部', '金管會', '外資', '法人',
      '電商', '零售', '百貨', '超商', '便利商店', '連鎖', '加盟',
      '薪資', '薪水', '加薪', '裁員', '失業率', '招聘', '就業',
      '電費', '油價', '天然氣', '能源', '通貨', '消費者物價', 'CPI', 'PMI',
      '地產', '不動產', '容積率', '都更', '購屋', '貸款', '利率', '股價',
    ],
  },
  {
    ...
    words: [
      ...
      '農業', '農產', '漁業', '水果', '蔬菜', '糧食', '食物',
      '寵物', '動物', '流浪動物', '收養',
      '文化', '歷史', '古蹟', '博物館', '藝術', '展覽', '表演', '節慶', '廟會',
      '道路', '橋梁', '公共建設', '停電', '停水', '維修', '施工',
      '運動', '健身', '跑步', '棒球', '籃球', '足球', '羽球', '網球', '游泳',
    ],
  },
  {
